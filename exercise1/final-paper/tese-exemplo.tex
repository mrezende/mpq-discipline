...
\newcommand{\chaptersize}{\fontsize{14}{12}\selectfont}
...
\begin{center}
    \vspace*{2.3cm}
    \textbf{\Large{Uso de redes neurais recorrentes na detecção de padrões de erros cometidos por alunos novatos}}\\
...
novices, introduction to programming, computational thinking, CS1; Programming Assignments; Automated Grading.
